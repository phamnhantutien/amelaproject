...
<div class="wrapper">
    ...
    @section('preloader')
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            {{-- <img class="animation__shake" src="{{ asset('storage/images/applogo2.png') }}" alt="AdminLTELogo" height="60" width="60"> --}}
    ...
    @section('sidebar')
        ...
        <a href="#" class="brand-link">
            ...
            <img src="{{ asset('adminlte/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image elevation-3" style="opacity: .8">
